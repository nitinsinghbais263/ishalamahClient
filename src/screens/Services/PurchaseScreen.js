...
class Purchare extends Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    return (
      <View style={{flex: 1}}>
        ...
        <TouchableOpacity activeOpacity={1} style={{ width: '100%', height: 50, alignItems:'center', justifyContent: 'center', backgroundColor: '#23BDE4' }} onPress={() => this.props.navigation.replace('InvoicesList')}>
...
export default connect(mapStateToProps,mapDispatchToProps)(Purchare);
