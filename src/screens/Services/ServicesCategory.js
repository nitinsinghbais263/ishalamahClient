...
class ServicesCategory extends Component {
  constructor(props) {
    super(props);
  }
...
state = {
  ...
  active:0,
  data: [
    { title: i18n.t('filter.all'), uuid: "" },
    { title: i18n.t('filter.active'), uuid: "Active" },
    { title: i18n.t('filter.pending'), uuid: "Pending" },
    { title: i18n.t('filter.expired'), uuid: "Expired" },
  ],
};
    ...
    return (
        <View style={{flexDirection: 'row',}}>
          {/*Filter*/}
            ...
            <View style={{width: '100%',flexDirection:'row', justifyContent: 'space-between', alignItems:'center',paddingTop:10, paddingHorizontal:10}}>
              <View>
              ...
              <View style={{width: '60%'}}>
                ...
                <TouchableOpacity onPress={() => this.toggleModal()}>
                  <View style={{height:35, padding:10, backgroundColor: '#F8F8F8', borderRadius:5, overflow: 'hidden', flexDirection: 'row', justifyContent: 'space-between', alignItems:'center'}}>
...
export default connect(mapStateToProps,mapDispatchToProps)(ServicesCategory);
